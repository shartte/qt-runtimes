...
namespace Build
{
    public class OSX64Platform : IPlatform
    {
        ...
        {
            var urls = Helpers.GetQtArchives("https://download.qt.io/online/qtsdkrepository/mac_x64/desktop/qt5_5150",
                    "qt.qt5.5150.clang_64",
                    "qt.qt5.5150.qtvirtualkeyboard.clang_64")
                .ToList();
